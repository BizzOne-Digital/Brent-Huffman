...
import HelpfulVideosSection, { HelpfulVideosNavLink } from "@/components/ui/HelpfulVideosSection";
...
export default function ServiceDetailClient({
  ...
  const isSystemTroubles = service.slug === "system-troubles";
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-end">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 items-center">
                ...
                {isSystemTroubles && (
                  <HelpfulVideosNavLink
                    className="inline-flex items-center gap-2 px-7 py-3.5 border-2 border-white/40 hover:border-white text-white font-bold text-sm rounded-full transition-all hover:bg-white/10"
                  />
                )}
              </div>
            </motion.div>
            ...
            <div className="max-w-[1400px] mx-auto px-6 sm:px-8">
              ...
              >
                <FadeIn direction={i % 2 === 0 ? "left" : "right"}>
                  ...
                  {isSystemTroubles && section.key === "intro" && <HelpfulVideosNavLink />}
                  <Link
                    href="/contact"
      ...
      {isSystemTroubles && <HelpfulVideosSection />}
